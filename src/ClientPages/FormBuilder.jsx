...
//   return elements.map(({ id, children, ...rest }) => {
//     const cleaned = { ...rest };
//     if (children && Array.isArray(children)) {
//       cleaned.children = removeIds(children);
//     }
//     return cleaned;
//   });
// };
...
const handleSaveForm = () => {
  const cleanedFormElements = removeIds(formData.formElements);
  ...
  const payload = {
    ...
    formData: {
      ...formData,
      formElements: cleanedFormElements,
    },
  };
